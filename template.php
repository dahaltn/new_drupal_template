 ...
 * Page alter.
 */
function dahal_page_alter($page) {
 ...
 */
function dahal_preprocess_html(&$variables) {
    /**
     * Add IE8 Support
     */
    ...
    if (theme_get_setting('bootstrap_css_cdn', 'dahal')) {
        $cdn = '//maxcdn.bootstrapcdn.com/bootstrap/' . theme_get_setting('bootstrap_css_cdn', 'dahal')  . '/css/bootstrap.min.css';
        drupal_add_css($cdn, array('type' => 'external'));
    }

    if (theme_get_setting('bootstrap_js_cdn', 'dahal')) {
        $cdn = '//maxcdn.bootstrapcdn.com/bootstrap/' . theme_get_setting('bootstrap_js_cdn', 'dahal')  . '/js/bootstrap.min.js';
     ...
     */
    if (theme_get_setting('scrolltop_display', 'dahal')) {
 ...
 */
function dahal_process_html(&$vars) {
 ...
 */
function dahal_preprocess_page(&$vars) {
 ...
 */
function dahal_process_page(&$variables) {
    // Hook into color.module.
    if (module_exists('color')) {
 ...
 */
function dahal_preprocess_block(&$variables) {
 ...
 */
function dahal_breadcrumb($variables) {
 ...
 */
function dahal_form_alter(&$form, &$form_state, $form_id) {
