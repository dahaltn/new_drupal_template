...
function dahal_form_system_theme_settings_alter(&$form, &$form_state) {
    ...
    $form['mtt_settings']['tabs']['basic_settings']['breadcrumb_display'] = array(
        ...
        '#default_value' => theme_get_setting('breadcrumb_display','dahal'),
    );
    ...
    $form['mtt_settings']['tabs']['basic_settings']['scrolltop_display'] = array(
        ...
        '#default_value' => theme_get_setting('scrolltop_display', 'dahal'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );
    ...
    $form['mtt_settings']['tabs']['ie8_support']['responsive_respond'] = array(
        ...
        '#default_value' => theme_get_setting('responsive_respond','dahal'),
