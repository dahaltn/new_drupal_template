        ...
        <div id="header-inside" class="clearfix">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <?php if ($page['logo_middle']) :?>
                        <?php print render($page['logo_middle']); ?>
                    <?php endif; ?>
...
<div id="page" class="clearfix">
        ...
        <div id="top-content" class="clearfix">
            ...
            <?php if ($page['hero_message']):?>
            <div class="container-fluid hero-message">

                <!-- #top-content-inside -->
                <div id="hero-message-inside" class="clearfix">
                    <div class="row">
                        <div class="col-md-12">
                            <?php print render($page['hero_message']); ?>
                        </div>
                    </div>
                </div>
                <!-- EOF:#hero-message-inside -->
